...
const Achievement = ({
  ...
  return (
    <div className="relative">
      ...
      <span className="z-1 absolute left-0 right-0 mx-auto top-1/2 -translate-y-1/2 container-center py-0.5 px-2.5 bg-semiDark text-2xl max-lg:text-xl text-primary text-nowrap">
        {achievement}
      </span>
    </div>
  );
